...
namespace BuildReportTool
{
	public partial class ReportGenerator
	{
		...
		/// build target from the BuildPlayerOptions that you pass. If your custom build
		/// script makes a BuildPlayerOptions, you can use this method to re-use that
		/// BuildPlayerOptions for generating the Build Report.
		/// </remarks>
		/// 
		/// <param name="customEditorLogPath">If your Unity Editor log file is not in
		/// the default path, specify it here. Otherwise, leave this null so that
		...
		{
			return CreateReport(buildPlayerOptions.scenes, buildPlayerOptions.locationPathName, buildPlayerOptions.target, customEditorLogPath);
		}
#endif
